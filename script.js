const translations = {
  es: {
    ...
    'proj-parking-desc': 'Esta es una app para escritorio, donde se gestionan los espacios del estacionamiento, los cobros y el control del dinero generado.',
    ...
    'proj-abarrotech-desc': 'Esta es una app para escritorio, es un punto de venta para una tienda de abarrotes típica en México. <br> En colaboración con <strong><a href="https://corvusstack.dev" class="colaboration">corvusstack</a></strong>',
    'proj-savelo-desc': 'Una aplicación que está en busca de ofertas de tiendas departamentales que ofrezcan a un costo más bajo sus productos próximos a caducar. <br> En colaboración con <strong><a href="https://corvusstack.dev" class="colaboration">corvusstack</a></strong>',
    'about-title': '¿Quién es el Dev Azteca?',
    'about-desc': 'Soy un estudiante de último semestre de Ingeniería en Electrónica y Computación en el Centro Universitario de los Valles (CUValles) de la Universidad de Guadalajara, sobre todo soy un desarrollador apasionado por las aplicaciones móviles. Estoy formándome como desarrollador nativo utilizando <strong>Swift</strong> para apps <strong>iOS</strong> y <strong>Kotlin</strong> para <strong>Android</strong> y que a su vez, utilizo la <strong>KMP</strong> para desarrollo de apps de escritorio.',
